            ...
            <footer className="footer-section">
                <div className="container-gt" id="footer-info">
                    ...
                    <p className="param-footer">
                        Dr. Estelle Gross Cyrus loves to hear from readers. You can reach her via email. 
                    ...
                    <nav>
                        <ul>
                            ...
                            <li>
                                <a 
                                    target="_blank"
                                    href="https://www.goodreads.com/book/show/52507567-from-vision-to-reality" rel="noreferrer">
                                    <FontAwesomeIcon 
                                        className='font-awesome'
                                        icon={faGoodreads} />
                                </a>
